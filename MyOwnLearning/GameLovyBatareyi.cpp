...
void GameLoviBatareyi::menuButtonFunctions()
{
	...
	if (menu.getMusicOffButton().getGlobalBounds().contains(this->mouseViewPos))
	{
...
{
	this->pointsOut.open("YourMomWeight.txt", std::ofstream::in);
	this->pointsInput.open("YourMomWeight.txt", std::ifstream::out);
